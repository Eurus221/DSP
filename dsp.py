...
def task1_window():
    ...
    displaybtn2 = tk.Button(gui, text="Display Result Signal", command=lambda: display(result_indices, result_samples), bg="#333333", fg="#ffffff", font=("Arial", 12), activebackground="#222222", activeforeground="#ffffff")
